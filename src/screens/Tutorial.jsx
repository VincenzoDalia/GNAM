...
import { HStack, VStack, Box, Flex, Text, Heading, Image, Badge, Card } from "@chakra-ui/react";
        ...
        <>
            <VStack
                ...
                _before={{
                    ...
                    position: "absolute",
                    inset: 0,
                    bg: { blueColorSpace }, // Sfondo per lo spinner
            ...
            >
                <VStack justifyContent="space-between" h={"100%"} className="TOP_BUTTON">
                    ...
                    <HStack gap={5} mt={4} w={"100%"} h={"100%"} alignItems="flex-start"  >
                        ...
                        >
                            <Box alignItems={"center"}>
                                <Badge pb={1} px="5" borderRadius={"50px"} bg={purpleColorButton}>
                                    <Text mb={0} pt="0" mt={0} fontSize="35px" color={whiteColorText} fontWeight={"bold"}>
                                        GNAM
                                    </Text>
                                </Badge>
                                <Text mt="1" px={8} fontWeight="bold" color={purpleColorButton} textAlign={"center"}>Tutorial {pages + 1}/3</Text>
                            </Box>

                            <Flex w="85%">
                                <Card alignItems={"center"} pb={4}>
                                    <Image mt={4} w={"50%"} src="src/assets/Skins/ClassicCarrot/PreviewTutorial.gif" />
                                    <Badge borderRadius={"50px"} px={3} mt={6} mb={3} py={1} bg={turquoiseColorBar}>
                                        <Text mb={0} color={whiteColorText} fontWeight="bold" fontSize="13px" textAlign={"justify"}>{titlePages[pages]}</Text>
                                    </Badge>
                                    <Text mt={3} mb={3} color={"gray.600"} px={8} fontSize="15px" textAlign={"justify"}>{textPages[pages]}</Text>
